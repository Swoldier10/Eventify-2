<div>
    ...
    <div class="p-4 sm:ml-64 mt-12">
        ...
        <div class="mt-4">
            <button type="button"
                    wire:click="prevPage"
                    class="{{ $selectedPageIndex == 0 ? 'hidden' : '' }} float-left flex gap-2 items-center font-bold focus:outline-none text-white bg-[#d2ad57] hover:bg-yellow-500 focus:ring-4 focus:ring-[#d2ad57] rounded-lg text-sm px-5 py-2 mb-2 dark:focus:ring-yellow-900">
            ...
            <button type="button"
                    wire:click="nextPage"
                    class="{{ $selectedPageIndex == 5 ? 'hidden' : '' }} flex gap-2 float-right items-center font-bold focus:outline-none text-white bg-[#d2ad57] hover:bg-yellow-500 focus:ring-4 focus:ring-[#d2ad57] rounded-lg text-sm px-5 py-2 mb-2 dark:focus:ring-yellow-900">
